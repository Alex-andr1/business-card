...
while (true){  
    ...
    if (type == 1){
        //alert(`Это будет стоить ${type1} рублей!`);
        //console.log(type1);
        break;
    }
    if (type == 2){
        //alert(`Это будет стоить ${type2} рублей!`);
        //console.log(type2);
        break;
    }
    if (type == 3){
        //alert(`Это будет стоить ${type3} рублей!`);
        //console.log(type3);
        break;
    }
...
while (true){  
    ...
    if (design == 1){
        //alert(`Это будет стоить ${design1} рублей!`);
        //console.log(design1);
        break;
    }
    if (design == 2){
        //alert(`Это будет стоить ${design2} рублей!`);
        //console.log(design2);
        break;
    }
    if (design == 3){
        //alert(`Это будет стоить ${design3} рублей!`);
        //console.log(design3);
        break;
    }
    alert("Ошибка. Неверное значение"); 
...
while (true){  
    ...
    if (adapt == 1){
        //alert(`Это будет стоить ${adapt1} рублей!`);
        //console.log(adapt1);
        break;
    }
    if (adapt == 2){
        //alert(`Это будет стоить ${adapt2} рублей!`);
        //console.log(adapt2);
        break;
    }
    if (adapt == 3){
        //alert(`Это будет стоить ${adapt3} рублей!`);
        //console.log(adapt3);
        break;
    }
    alert("Ошибка. Неверное значение"); 
